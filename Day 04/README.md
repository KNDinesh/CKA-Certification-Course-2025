...
If we execute **docker run `<docker-image-with-custom-Dockerfile-name>` ls** it will override ping command and run the ls command in the container and the output will be printed in the terminal.
